    ...
    def fetch_transcript(self, video_url_or_id: str):
        ...
        try:
            ...
            transcript = fetch_youtube_transcript(
                video_id, self.settings["languages"])
    ...
    def upload_to_azure(self):
        ...
        try:
            ...
            transcript_document = storage.create_transcript_document(
                ...
                # We don't have title from the grabber
                video_title=f"Video {self.last_video_id}",
            ...
            if result_path:
                ...
                print(
                    f"📄 Full transcript with {len(self.last_transcript)} entries")
